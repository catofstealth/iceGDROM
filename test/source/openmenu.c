...
int test_get_ver()
{
  uint8_t[11] params = { 0x00, 0x00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}
  cdops_exec_cmd(0x52, &params);
  return 0;
}
int test_next_image()
{
  uint8_t[11] params = { 0x81, 0x55, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}
  cdops_exec_cmd(0x52, &params);
  return 0;
}
int test_prev_image()
{
  uint8_t[11] params = { 0x81, 0x44, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}
  cdops_exec_cmd(0x52, &params);
  return 0;
}
int test_load_indexed_image()
{
  uint8_t[11] params = { 0x82, 0x01, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}
  cdops_exec_cmd(0x52, &params);
  return 0;
}
